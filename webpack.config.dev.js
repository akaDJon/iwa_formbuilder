...
module.exports = {
  ...
  plugins: [
    ...
    new HTMLWebpackPlugin({
      ...
      minify: false,
      filename: path.resolve(__dirname, "./demo/dev/index.html"),
    }),
    new CopyWebpackPlugin({
      patterns: [
        { from: path.resolve(__dirname, "./src/favicon/favicon.ico"), to: path.resolve(__dirname, "./demo/dev") },
        { from: path.resolve(__dirname, "./src/php/index.php"), to: path.resolve(__dirname, "./demo/dev") },
      ]
    }),
